                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl text-padi md:text-6xl lg:mt-16 xl:text-7xl">Build 10x Faster with NS</h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg text-padi/80">Highly customizable components for building modern websites and applications you mean it.</p>

                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    <Button
                                        asChild
                                        size="lg"
                                        className="h-12 rounded-full bg-padi pl-5 pr-3 text-base text-batu hover:bg-padi/90">
                                        <Link href="#link">
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-12 rounded-full px-5 text-base text-padi hover:bg-white/10">
                                        <Link href="#link">
                        ...
                        <div className="absolute inset-1 overflow-hidden rounded-3xl border border-black/10 lg:rounded-[3rem]">
                            <div className="size-full bg-gradient-to-br from-batu via-kabut to-padang opacity-95" />
                        </div>
                    </div>
                </section>
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto max-w-7xl rounded-3xl px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-padi/80 backdrop-blur-2xl')}>
                    <motion.div
                        key={1}
                                ...
                                <ul className="flex gap-8 text-sm">
                                    {menuItems.map((item, index) => (
                                        <li key={index}>
                                            <Link
                                                href={item.href}
                                                className="text-kabut/70 hover:text-batu block duration-150">
                                                <span>{item.name}</span>
                                            </Link>
                                        </li>
                                    ))}
                        ...
                        <div className="bg-padi group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-batu/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className="border-batu/30 text-batu hover:bg-batu/5">
                                    <Link href="#">
                                        <span>Login</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className="bg-batu text-padi hover:bg-batu/90">
                                    <Link href="#">
                                        <span>Sign Up</span>
                                    </Link>
                                </Button>
        ...
        <svg
            ...
            <defs>
                <linearGradient
                    ...
                    <stop stopColor="#3A4034" />
                    <stop offset="1" stopColor="#93A275" />
                </linearGradient>
            </defs>
        </svg>
    )
